...
exports.resolvers = {
    ...
    Mutation: {
        ...
        createlicense: (_, { domain }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const hashedDomain = yield argon2.hash(domain);
        ...
        signlicense: (_, { domain, ip, license }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const valid = yield argon2.verify(lc.license, license);
            if (!valid) {
                signNuller();
                return false;
            }
